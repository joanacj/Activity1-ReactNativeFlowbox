...
const Picture = () => {
  return(
    <View>
       <Image source={{ uri: 'https://th.bing.com/th/id/OIP.ixxZJyORw2W2VCYfse4yAAHaNK?pid=ImgDet&rs=1'}} style ={styles.Picture} />
     </View>
  ) 
};
const BioData = () =>{
  return(
    <View> 
<Text style ={styles.name}>Joana C. Jagunos </Text>
